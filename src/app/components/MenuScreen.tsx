...
import { Home, Menu, ShoppingCart, Heart, User, Search, SlidersHorizontal } from 'lucide-react';
    ...
    <div className="min-h-screen bg-neutral-100 flex flex-col" style={{ width: '390px', height: '844px', margin: '0 auto' }}>
      ...
      <div className="bg-white border-b border-neutral-300 px-6 py-4">
        <div className="flex items-center gap-3 mb-0">
          <div className="flex-1 bg-neutral-200 rounded-lg px-4 py-3 flex items-center gap-3">
            ...
            <div key={item.id} className="bg-white rounded-lg p-4 flex gap-4">
              ...
              <div className="flex-1 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  <button className="w-16 h-8 bg-neutral-800 rounded flex items-center justify-center">
